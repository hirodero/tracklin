            ...
            <div className="flex flex-col items-center w-full max-w-[600px] gap-7">
                ...
                <div className="flex flex-col items-center bg-white/90 p-10 rounded-3xl shadow-2xl w-full border-2 border-[#0026A4]">
                    ...
                    <form onSubmit={submit} className="flex flex-col w-full gap-4">
                        ...
                        <button
                            type="submit"
                            className="mt-2 bg-[#1976D2] hover:bg-[#42A5F5] text-white text-lg py-3 rounded-2xl shadow-md active:scale-95 transition border-2 border-[#0026A4]"
                            disabled={processing}
                        >
                            {processing ? 'Updating...' : 'Reset Password'}
                        </button>

                        <div className="flex justify-center text-sm text-[#0026A4] mt-3">
