    ...
    return (
        <>
            ...
            <div className="min-h-screen flex items-center justify-center bg-slate-950">
                <div className="max-w-lg w-full mx-4 rounded-2xl bg-slate-900/90 border border-slate-700 shadow-2xl shadow-blue-900/40 p-8 text-slate-100">
                    <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-blue-900/30 border border-blue-500/60 text-[11px] font-semibold uppercase tracking-[0.18em] mb-4">
                        <span className="w-2 h-2 rounded-full bg-orange-400 shadow-[0_0_0_6px_rgba(248,113,113,0.25)]" />
                        Database Offline
                    </div>
                    ...
                    <button
                        ...
                        className="inline-flex items-center justify-center px-4 py-2.5 rounded-xl text-sm font-medium bg-gradient-to-r from-blue-500 to-emerald-400 text-white shadow-lg shadow-blue-500/50 hover:shadow-blue-500/70 hover:scale-[1.01] active:scale-100 transition-transform transition-shadow duration-150"
                    >
                        Refresh Page
                    </button>
